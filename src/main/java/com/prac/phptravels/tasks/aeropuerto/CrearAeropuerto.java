...
public class CrearAeropuerto implements Task {
    ...
    public CrearAeropuerto(String estado, String codigo, String nombre, String ciudad, String pais) {
        this.estado = estado;
        this.codigo = codigo;
        this.nombre = nombre;
        this.ciudad = ciudad;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Click.on(CrearAeropuertoForm.BTN_SAVE_AIRPORT)
    ...
    public static class CrearAeropuertoConBuilder {
        ...
        public Performable run(){
            ...
            return Instrumented.instanceOf(CrearAeropuerto.class)
